...
[![Platform: Android](https://img.shields.io/badge/android-APK-10b981)](https://storage.googleapis.com/karatuai-models/apks/karatuai-android-v1.2.1.apk)
...
The current published APK is `karatuai-android-v1.2.1.apk` (~3.9 MB, signed release build), uploaded to `gs://karatuai-models/apks/`. iOS is not yet shipped because on-device AI does not fit in iPhone WebKit's per-tab memory budget — a native iOS app is on the roadmap.
